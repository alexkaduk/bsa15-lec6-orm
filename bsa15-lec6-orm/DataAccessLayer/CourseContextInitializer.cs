        ...
        protected override void Seed(CourseContext courseContext)
        {
            ...
            var answers = new List<Answer>
            {
                ...
                new Answer()
                {
                    Correct = false,
                    Text = "Answer text",
                    Question = courseContext.Questions.SingleOrDefault(i=>i.Id == 1),
                    TestWork = courseContext.TestWorks.SingleOrDefault(tw=>tw.Id == 1)
                },
                new Answer()
                {
                    Correct = false,
                    Text = "Answer text",
                    Question = courseContext.Questions.SingleOrDefault(i=>i.Id == 2),
                    TestWork = courseContext.TestWorks.SingleOrDefault(tw=>tw.Id == 1)
                },
                new Answer()
                {
                    Correct = true,
                    Text = "Answer text",
                    Question = courseContext.Questions.SingleOrDefault(i=>i.Id == 7),
                    TestWork = courseContext.TestWorks.SingleOrDefault(tw=>tw.Id == 1)
                },
                new Answer()
                {
                    Correct = true,
                    Text = "Answer text",
                    Question = courseContext.Questions.SingleOrDefault(i=>i.Id == 8),
                    TestWork = courseContext.TestWorks.SingleOrDefault(tw=>tw.Id == 1)
                },
                new Answer()
                {
                    Correct = true,
                    Text = "Answer text",
                    Question = courseContext.Questions.SingleOrDefault(i=>i.Id == 9),
                    TestWork = courseContext.TestWorks.SingleOrDefault(tw=>tw.Id == 1)
                },
                new Answer()
                {
                    Correct = true,
                    Text = "Answer text",
                    Question = courseContext.Questions.SingleOrDefault(i=>i.Id == 10),
                    TestWork = courseContext.TestWorks.SingleOrDefault(tw=>tw.Id == 1)
                },
                new Answer()
                {
                    Correct = false,
                    Text = "Answer text",
                    Question = courseContext.Questions.SingleOrDefault(i=>i.Id == 11),
                    TestWork = courseContext.TestWorks.SingleOrDefault(tw=>tw.Id == 1)
                },
                new Answer()
                {
                    Correct = false,
                    Text = "Answer text",
                    Question = courseContext.Questions.SingleOrDefault(i=>i.Id == 12),
                    TestWork = courseContext.TestWorks.SingleOrDefault(tw=>tw.Id == 1)
                },
                new Answer()
                {
                    Correct = false,
                    Text = "Answer text",
                    Question = courseContext.Questions.SingleOrDefault(i=>i.Id == 13),
                    TestWork = courseContext.TestWorks.SingleOrDefault(tw=>tw.Id == 1)
                },
#endregion
                ...
                new Answer()
                {
                    ...
                    Text = "Answer text",
                    Question = courseContext.Questions.SingleOrDefault(i=>i.Id == 1),
                    TestWork = courseContext.TestWorks.SingleOrDefault(tw=>tw.Id == 2)
                },
                new Answer()
                {
                    Correct = false,
                ...
                new Answer()
                {
                    ...
                    Text = "Answer text",
                    Question = courseContext.Questions.SingleOrDefault(i=>i.Id == 1),
                    TestWork = courseContext.TestWorks.SingleOrDefault(tw=>tw.Id == 3)
                },
                new Answer()
                {
                    Correct = false,
                ...
                new Answer()
                {
                    ...
                    Text = "Answer text",
                    Question = courseContext.Questions.SingleOrDefault(i=>i.Id == 1),
                    TestWork = courseContext.TestWorks.SingleOrDefault(tw=>tw.Id == 4)
                },
                new Answer()
                {
                    Correct = false,
                ...
                new Answer()
                {
                    Correct = false,
                    Text = "Answer text",
                    Question = courseContext.Questions.SingleOrDefault(i=>i.Id == 3),
                    TestWork = courseContext.TestWorks.SingleOrDefault(tw=>tw.Id == 5)
                },
                new Answer()
                {
                    Correct = false,
                    Text = "Answer text",
                    Question = courseContext.Questions.SingleOrDefault(i=>i.Id == 4),
                    TestWork = courseContext.TestWorks.SingleOrDefault(tw=>tw.Id == 5)
                },
                new Answer()
                {
                ...
                new Answer()
                {
                    ...
                    Text = "Answer text",
                    Question = courseContext.Questions.SingleOrDefault(i=>i.Id == 3),
                    TestWork = courseContext.TestWorks.SingleOrDefault(tw=>tw.Id == 6)
                },
                new Answer()
                {
                    Correct = false,
                ...
                new Answer()
                {
                    Correct = false,
                    Text = "Answer text",
                    Question = courseContext.Questions.SingleOrDefault(i=>i.Id == 5),
                    TestWork = courseContext.TestWorks.SingleOrDefault(tw=>tw.Id == 7)
                },
                new Answer()
                {
                    Correct = true,
                    Text = "Answer text",
                    Question = courseContext.Questions.SingleOrDefault(i=>i.Id == 6),
                    TestWork = courseContext.TestWorks.SingleOrDefault(tw=>tw.Id == 7)
                },
                new Answer()
                {
                ...
                new Answer()
                {
                    ...
                    Text = "Answer text",
                    Question = courseContext.Questions.SingleOrDefault(i=>i.Id == 5),
                    TestWork = courseContext.TestWorks.SingleOrDefault(tw=>tw.Id == 8)
                },
                new Answer()
                {
                    Correct = true,
                ...
                new Answer()
                {
                    ...
                    Text = "Answer text",
                    Question = courseContext.Questions.SingleOrDefault(i=>i.Id == 5),
                    TestWork = courseContext.TestWorks.SingleOrDefault(tw=>tw.Id == 9)
                },
                new Answer()
                {
                    Correct = false,
            ...
            answers.ForEach(t => courseContext.Answers.AddOrUpdate(p => p.Id, t));
            courseContext.SaveChanges();
